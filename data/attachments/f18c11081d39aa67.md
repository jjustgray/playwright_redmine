...
Locator: getByLabel('Add filter').or(locator('select#add_filter_select'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel('Add filter').or(locator('select#add_filter_select'))
...
- insertion:
  ...
  - link "Web application hosting"
  - link "Bug tracking software"
  - link "Project management training"
  - link "Redmine plugin development"
...
- insertion:
  ...
  - link "Software integration service"
- paragraph:
